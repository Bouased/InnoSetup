...
Source: "Help\ishelp\Staging\ISetup.chm"; DestDir: "{app}"; Flags: ignoreversion touch
...
Source: "Help\ISPPHelp\Staging\ISPP.chm"; DestDir: "{app}"; Flags: ignoreversion touch
#ifndef isppdll
